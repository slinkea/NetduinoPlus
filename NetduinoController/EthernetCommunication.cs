...
namespace Netduino.Controller
{
    ...
    class EthernetCommunication
    {
        ...
        {
            if (se.ErrorCode == (int)SocketError.NetworkDown)
            {
                Debug.Print("Network Down!");
            }
            else if (se.ErrorCode == (int)SocketError.ConnectionAborted)
            {
                Debug.Print("Connection Aborted!");
            }
            else if (se.ErrorCode == (int)SocketError.ConnectionReset)
            {
                Debug.Print("Connection Reset!");
            }
            else
            {
